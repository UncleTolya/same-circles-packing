define(["require", "exports"], function (require, exports) {
    ...
    exports.getFittedCentresRightLine = exports.getFittedCentresSpiral = exports.noop = void 0;
    exports.noop = (...elements) => { };
    ...
    exports.getFittedCentresSpiral = (area, circleRadius, maximum = 10000) => {
        let firstCenter;
        try {
    ...
    exports.getFittedCentresRightLine = (area, circleRadius, maximum = 10000) => {
        let firstCenter;
        try {
            firstCenter = area.findFirstCircleCenter(circleRadius);
        }
