...
export abstract class Area {
  ...
  public findFirstCircleCenter(
    ...
    const checkNewRadiusStartPosition = (): boolean => {
      return this.isCircleFit(
        {
          x: initX,
          y: initY,
          r: circleRadius,
    ...
    if (checkNewRadiusStartPosition() || checkCeilRightSide() || checkRightSide() || checkBottom() || checkLeftSide() || checkCeilLeftSide()) {
